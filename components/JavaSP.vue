<template>
  <div>
    <!-- s create records -->
    <div>
      <h3 class="text-center">Create Data (Java Spring boot)</h3>
      <hr />
      <v-row>
        <v-col cols="4">&nbsp;</v-col>
    ...
    <!-- s get records -->
    <div>
      <h3 class="text-center mymt">Get Data (Java Spring Boot)</h3>
      <hr />
      <v-row>
        <v-col cols="4">&nbsp;</v-col>
        <v-col cols="4" class="mt-4">
    ...
    <!-- s update records -->
    <div>
      <h3 class="text-center mymt">Update Data (Java Spring Boot)</h3>
      <hr />
      <v-row>
        <v-col cols="4">&nbsp;</v-col>
        <v-col cols="4" class="mt-4">
    ...
    <!-- s delete records -->
    <div>
      <h3 class="text-center mymt">Delete Data (Java Spring Boot)</h3>
      <hr />
      <v-row>
        <v-col cols="4">&nbsp;</v-col>
        <v-col cols="4" class="mt-4">
...
export default {
  ...
  methods: {
    async submitAdd() {
      ...
      await this.$axios
        .post(`http://localhost:8080/api/customersQue/${this.numRecord}`, sdata)
        .then((res) => {
    ...
    async submitGet() {
      ...
      await this.$axios
        .get(`http://localhost:8080/api/customersByLimit/${this.numRecordGet}`)
        .then((res) => {
    ...
    async submitUpdate() {
      ...
      await this.$axios
        .put(
          `http://localhost:8080/api/customerQue/${this.numRecordUpdate}`,
          supdatedata
        )
        .then((res) => {
    ...
    async submitDelete() {
      ...
      await this.$axios
        .delete(
          `http://localhost:8080/api/customersQue/${this.numRecordDelete}`
        )
        .then((res) => {
